...
all_periods <- gsub("^2005, 2006, 2007 & 2008$", "2005-2005, 2006-2006, 2007-2008", all_periods, fixed = FALSE)
...
all_periods <- gsub("^2008, 11, 15$", "2008, 2011, 2015", all_periods, fixed = FALSE)
all_periods <- gsub("^2003-09, 11-12$", "2003-09, 2011-2012", all_periods, fixed = FALSE)
...
norm_periods <- gsub("^2015-2015-$", "2015-2015", norm_periods, fixed = FALSE)
norm_periods <- gsub("^2015-2016-$", "2015-2016", norm_periods, fixed = FALSE)
